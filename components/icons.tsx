...
export const GarmentIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="w-full h-full" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l7.5-7.5 7.5 7.5M4.5 12.75v6a2.25 2.25 0 002.25 2.25h10.5a2.25 2.25 0 002.25-2.25v-6" />
  </svg>
);
...
export const RefineIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6V4m0 16v-2m8-8h2M4 12H2m15.364 6.364l1.414 1.414M4.222 4.222l1.414 1.414m14.142 0l-1.414 1.414M6.636 19.778l-1.414-1.414M12 18a6 6 0 100-12 6 6 0 000 12z" />
  </svg>
);
...
export const CloningIcon: React.FC = () => (
...
export const CoreExtractionIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-full w-full" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.042 21.37a8.962 8.962 0 01-1.297-.487 8.963 8.963 0 01-7.487-8.134 8.963 8.963 0 01.32-3.717 8.963 8.963 0 013.438-4.632 8.963 8.963 0 014.632-3.438 8.963 8.963 0 013.717-.32 8.963 8.963 0 018.134 7.487 8.962 8.962 0 01-.487 1.297" transform="rotate(45 12 12)" />
  </svg>
);

export const MaleIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-full w-full" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M11 16.5A5.5 5.5 0 1011 5.5a5.5 5.5 0 000 11zM14.5 9.5L19 5m0 0h-4m4 0v4" />
  </svg>
);

export const FemaleIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-full w-full" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 15a6 6 0 100-12 6 6 0 000 12zm0 0v6m-3-3h6" />
  </svg>
);

export const VirtualPhotoshootIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="w-full h-full" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
    <circle cx="12" cy="12" r="9" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M5 14c0-2.76 3.13-5 7-5s7 2.24 7 5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M5 14v2h14v-2" />
  </svg>
);

export const AssetGeneratorIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="w-full h-full" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
    <rect x="10" y="4" width="4" height="4" />
    <rect x="8" y="9" width="8" height="6" />
    <rect x="8" y="16" width="3" height="5" />
    <rect x="13" y="16" width="3" height="5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M4 8v8m16-8v8M8 4h8m-8 16h8" />
  </svg>
);

export const ProductForgeIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="w-full h-full" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
    <path strokeLinecap="round" strokeLinejoin="round" d="M4 14c0 4.418 4.03 8 9 8s9-3.582 9-8-4.03-8-9-8-9 3.582-9 8z" transform="matrix(1 0 0 0.5 0 2)" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 2v6" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 8h6l-3 4-3-4z" fill="currentColor" />
  </svg>
);
...
export const StyleSceneIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="w-full h-full" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 11.5a2.5 2.5 0 100-5 2.5 2.5 0 000 5z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 21v-6a3 3 0 013-3h0a3 3 0 013 3v6" />
...
export const FixItIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="w-full h-full" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export const ChangeBackgroundIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="w-full h-full" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
